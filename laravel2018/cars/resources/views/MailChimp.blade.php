...
@endif
	...
	<div class="row">
		...
		<div class="col-md-7">
          ...
          <fieldset>
            <legend class="text-center">siusti</legend>

    
            <!-- Name input-->
            <div class="form-group">
              <label class="col-md-3 control-label" for="name">Vardas</label>
              <div class="col-md-9">
            ...
            <!-- Email input-->
            <div class="form-group">
              <label class="col-md-3 control-label" for="email">Kam</label>
              <div class="col-md-9">
            ...
            <!-- From Email input-->
            <div class="form-group">
              <label class="col-md-3 control-label" for="email">emailas</label>
              <div class="col-md-9">
            ...
            <!-- Message body -->
            <div class="form-group">
              <label class="col-md-3 control-label" for="message">Jūsų žinutė</label>
              <div class="col-md-9">
            ...
            <div class="form-group">
              <div class="col-md-12 text-right">
                <button type="submit" class="btn btn-primary btn-lg">Siusti</button>
              </div>
            </div>
          </fieldset>
          {!! Form::close() !!}
